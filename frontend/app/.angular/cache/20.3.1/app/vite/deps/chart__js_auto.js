...
var _lookupByKey = /* @__PURE__ */ __name((table, key, value, last) => _lookup(table, value, last ? (index2) => {
...
var getScope = /* @__PURE__ */ __name((key, parent) => key === true ? parent : typeof key === "string" ? resolveObjectKey(parent, key) : void 0, "getScope");
...
var addIfFound = /* @__PURE__ */ __name((set2, obj, key) => {
...
var validIndex = /* @__PURE__ */ __name((index2, max) => index2 === null ? null : _limitValue(Math.round(index2), 0, max), "validIndex");
